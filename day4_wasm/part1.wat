...
(module
  ...
  (func $solve (result i64)
    ...
    (loop $line_loop
      ...
      ;; lo_b >= lo_a and hi_b <= hi_a
      (i32.and
        (i64.ge_s (local.get $b_lo) (local.get $a_lo))
        (i64.le_s (local.get $b_hi) (local.get $a_hi)))

      ;; lo_a >= lo_b and hi_a <= hi_b
      (i32.and
        (i64.ge_s (local.get $a_lo) (local.get $b_lo))
